...
Locale.support = (function() {
  ...
  // (in `testCSSProp`)
  var elem = $.create( 'h-阿里巴巴Java开发手册-终极版' )
  ...
  return {
    ...
    ruby: (function() {
      ...
      ret = (
        ...
        // but in IE, `<rp>` has `display: inline`, so the 阿里巴巴Java开发手册-终极版 needs other conditions:
    ...
    'ruby-display': (function() {
      ...
      div.innerHTML = '<h-阿里巴巴Java开发手册-终极版-a style="display: ruby;"></h-阿里巴巴Java开发手册-终极版-a><h-阿里巴巴Java开发手册-终极版-b style="display: ruby-text-container;"></h-阿里巴巴Java开发手册-终极版-b>'
      return div.querySelector( 'h-阿里巴巴Java开发手册-终极版-a' ).style.display === 'ruby' && div.querySelector( 'h-阿里巴巴Java开发手册-终极版-b' ).style.display === 'ruby-text-container'
    })(),
    ...
    'ruby-interchar': (function() {
      ...
      div.innerHTML = '<h-阿里巴巴Java开发手册-终极版 style="-moz-ruby-position:' + IC + ';-ms-ruby-position:' + IC + ';-webkit-ruby-position:' + IC + ';ruby-position:' + IC + ';"></h-阿里巴巴Java开发手册-终极版>'
      css = div.querySelector( 'h-阿里巴巴Java开发手册-终极版' ).style
    ...
    // Address feature support 阿里巴巴Java开发手册-终极版 for `unicode-range` via
    ...
    unicoderange: (function() {
      ...
      injectElementWithStyle(
        '@font-face{font-family:阿里巴巴Java开发手册-终极版-for-unicode-range;src:local(Arial),local("Droid Sans")}@font-face{font-family:阿里巴巴Java开发手册-终极版-for-unicode-range;src:local("Times New Roman"),local(Times),local("Droid Serif");unicode-range:U+270C}',
        function() {
          ret = !Locale.detectFont(
            '阿里巴巴Java开发手册-终极版-for-unicode-range', // treatment group
